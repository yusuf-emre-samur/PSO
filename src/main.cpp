...
{   
    ...
    // parameter
    const pso::ParticleParameter particle_params(0.9, 0.5, 1.49, 1.49, iterations, v_max, x_spawn);
    const pso::SwarmParameter swarm_params(population_size, problem_function, problem_function_name, particle_params);
